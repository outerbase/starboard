...
let TableRow = class TableRow extends ClassifiedElement {
    ...
    get classMap() {
        return {
            ...
            'odd:bg-theme-row-odd dark:odd:bg-theme-row-odd-dark even:bg-theme-row-even dark:even:bg-theme-row-even-dark hover:bg-theme-row-hover dark:hover:bg-theme-row-hover-dark': !this.new && !this.isHeaderRow && !this.selected,
            // when selected
